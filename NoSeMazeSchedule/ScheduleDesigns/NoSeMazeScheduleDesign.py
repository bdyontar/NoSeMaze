...
class Ui_Form(object):
    def setupUi(self, Form: QtWidgets.QWidget):
        ...
        Form.resize(502, 372)
        self.gridLayout: QtWidgets.QGridLayout = QtWidgets.QGridLayout(Form)
        self.gridLayout.setObjectName("gridLayout")
        self.label_5: QtWidgets.QLabel = QtWidgets.QLabel(Form)
        self.label_5.setObjectName("label_5")
        self.gridLayout.addWidget(self.label_5, 8, 4, 1, 2)
        self.label_7: QtWidgets.QLabel = QtWidgets.QLabel(Form)
        self.label_7.setObjectName("label_7")
        self.gridLayout.addWidget(self.label_7, 11, 0, 1, 2)
        self.line: QtWidgets.QFrame = QtWidgets.QFrame(Form)
        self.line.setFrameShape(QtWidgets.QFrame.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.gridLayout.addWidget(self.line, 3, 0, 1, 9)
        self.line_2: QtWidgets.QFrame = QtWidgets.QFrame(Form)
        self.line_2.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.gridLayout.addWidget(self.line_2, 10, 0, 1, 9)
        self.pretrainingCheck: QtWidgets.QRadioButton = QtWidgets.QRadioButton(
            Form)
        ...
        self.label_12: QtWidgets.QLabel = QtWidgets.QLabel(Form)
        self.label_12.setObjectName("label_12")
        self.gridLayout.addWidget(self.label_12, 11, 5, 1, 3)

        # reward map table
        self.rewardMapTable: QtWidgets.QTableWidget = QtWidgets.QTableWidget(
            Form)
        ...
        self.label: QtWidgets.QLabel = QtWidgets.QLabel(Form)
        self.label.setObjectName("label")
        self.gridLayout.addWidget(self.label, 1, 0, 1, 4)

        self.label_15: QtWidgets.QLabel = QtWidgets.QLabel(Form)
        self.label_15.setObjectName("label_15")
        self.gridLayout.addWidget(
            self.label_15, 1, 6, 1, 2, QtCore.Qt.AlignTop)
        self.trialOnsetEdit: QtWidgets.QLineEdit = QtWidgets.QLineEdit(Form)
        self.trialOnsetEdit.setObjectName("trialOnsetEdit")
        self.gridLayout.addWidget(self.trialOnsetEdit, 9, 4, 1, 2)
        self.lickFractionEdit: QtWidgets.QLineEdit = QtWidgets.QLineEdit(Form)
        self.lickFractionEdit.setObjectName("lickFractionEdit")
        self.gridLayout.addWidget(self.lickFractionEdit, 9, 8, 1, 1)
        self.label_10: QtWidgets.QLabel = QtWidgets.QLabel(Form)
        self.label_10.setObjectName("label_10")
        self.gridLayout.addWidget(self.label_10, 8, 8, 1, 1)
        self.label_13: QtWidgets.QLabel = QtWidgets.QLabel(Form)
        self.label_13.setObjectName("label_13")
        self.gridLayout.addWidget(self.label_13, 8, 2, 1, 1)
        self.odourTrainingCheck: QtWidgets.QRadioButton = QtWidgets.QRadioButton(
            Form)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_12.setText(_translate(
            "Form", "<html><head/><body><p align=\"right\">Number of odours:</p></body></html>"))
        self.rewardMapTable.setToolTip(_translate(
            "Form", "<html><head/><body><p>the columns represent the odours</p></body></html>"))
        ...
        self.label.setText(_translate(
            "Form", "<html><head/><body><p><span style=\" font-size:14pt;\">NoSeMaze - Schedule</span></p></body></html>"))
        ...
        self.label_13.setText(_translate("Form", "Odour Training"))
