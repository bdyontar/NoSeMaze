...
class RiskWidget(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.groupLayout =QtWidgets.QGridLayout(self.groupbox)
        self.textbox = QtWidgets.QLabel("Not implemented yet.")
...
class GNGWidget(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.animalPerformanceView = PlotWidget(self)
        ...
        self.groupPerformanceView = PlotWidget(self)
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gngLWidget = GNGWidget()
        self.gngRWidget = GNGWidget()
