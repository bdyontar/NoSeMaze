...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.cameraTwoBox = QtWidgets.QGroupBox(self.centralwidget)
        self.cameraTwoBox.setObjectName("cameraTwoBox")
        self.gridLayout_3 = QtWidgets.QGridLayout(self.cameraTwoBox)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.camTwoView = QtWidgets.QGraphicsView(self.cameraTwoBox)
        ...
        self.cameraOneBox = QtWidgets.QGroupBox(self.centralwidget)
        self.cameraOneBox.setObjectName("cameraOneBox")
        self.gridLayout = QtWidgets.QGridLayout(self.cameraOneBox)
        self.gridLayout.setObjectName("gridLayout")
        self.camOneView = QtWidgets.QGraphicsView(self.cameraOneBox)
        ...
        self.licksView = PlotWidget(self.centralwidget)
        ...
        self.animalListTable = QtWidgets.QTableView(self.centralwidget)
