...
class Ui_DockWidget(object):
    def setupUi(self, DockWidget : QtWidgets.QDockWidget):
        DockWidget.setObjectName("DockWidget")
        DockWidget.resize(473, 152)
        DockWidget.setFloating(False)
        self.dockWidgetContents : QtWidgets.QWidget = QtWidgets.QWidget()
        self.dockWidgetContents.setObjectName("dockWidgetContents")
        self.gridLayout : QtWidgets.QGridLayout = QtWidgets.QGridLayout(self.dockWidgetContents)
        self.gridLayout.setObjectName("gridLayout")
        self.saturationSlider : QtWidgets.QSlider = QtWidgets.QSlider(self.dockWidgetContents)
        ...
        self.brightnessSlider : QtWidgets.QSlider= QtWidgets.QSlider(self.dockWidgetContents)
        self.brightnessSlider.setMinimum(-100)
        self.brightnessSlider.setMaximum(100)
        self.brightnessSlider.setOrientation(QtCore.Qt.Horizontal)
        self.brightnessSlider.setObjectName("brightnessSlider")
        self.gridLayout.addWidget(self.brightnessSlider, 0, 1, 1, 1)
        self.label_2 : QtWidgets.QLabel = QtWidgets.QLabel(self.dockWidgetContents)
        self.label_2.setObjectName("label_2")
        self.gridLayout.addWidget(self.label_2, 1, 0, 1, 1)
        self.contrastSlider : QtWidgets.QSlider = QtWidgets.QSlider(self.dockWidgetContents)
        self.contrastSlider.setMinimum(-100)
        self.contrastSlider.setMaximum(100)
        self.contrastSlider.setOrientation(QtCore.Qt.Horizontal)
        self.contrastSlider.setObjectName("contrastSlider")
        self.gridLayout.addWidget(self.contrastSlider, 1, 1, 1, 1)
        self.label_3 : QtWidgets.QLabel = QtWidgets.QLabel(self.dockWidgetContents)
        self.label_3.setObjectName("label_3")
        self.gridLayout.addWidget(self.label_3, 0, 0, 1, 1)
        self.label : QtWidgets.QLabel = QtWidgets.QLabel(self.dockWidgetContents)
