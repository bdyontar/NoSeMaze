...
class Ui_Form(object): #DONE Namenänderung und Einbinden von Wahrscheinlichkeit und Länge des Wasserzufuhr
    def setupUi(self, Form):
        ...
        self.rewardMapTable.setRowCount(4)
...
#        self.label_11.setText(_translate("Form", "<html><head/><body><p>Reward Map : <br/>0 = not rewarded<br/>1 = rewarded</p></body></html>"))
        ...
        item.setText(_translate("Form", "Amount of Reward Left Port"))
        item = self.rewardMapTable.verticalHeaderItem(3)
        item.setText(_translate("Form", "Amount of Reward Right Port"))
        ...
        item.setText(_translate("Form", "0.4"))
