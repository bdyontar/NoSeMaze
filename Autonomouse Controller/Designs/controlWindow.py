...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        spacerItem = QtWidgets.QSpacerItem(480, 5, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem, 1, 0, 1, 1)
        self.groupBox = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox.setObjectName("groupBox")
        self.gridLayout_3 = QtWidgets.QGridLayout(self.groupBox)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.viewfinderOne = QCameraViewfinder(self.groupBox)
        ...
        spacerItem1 = QtWidgets.QSpacerItem(640, 5, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        self.animalListTable.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.gridLayout.addWidget(self.animalListTable, 0, 0, 1, 1)
        spacerItem2 = QtWidgets.QSpacerItem(5, 480, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout.addItem(spacerItem2, 0, 1, 1, 1)
        spacerItem3 = QtWidgets.QSpacerItem(5, 480, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        self.menuSet_Cameras = QtWidgets.QMenu(self.menuSetting)
        self.menuSet_Cameras.setObjectName("menuSet_Cameras")
        self.menuSet_Resolutions = QtWidgets.QMenu(self.menuSetting)
        self.menuSet_Resolutions.setObjectName("menuSet_Resolutions")
        self.menuAdjustment = QtWidgets.QMenu(self.menuSetting)
        ...
        self.actionRes_Camera_1 = QtWidgets.QAction(MainWindow)
        self.actionRes_Camera_1.setObjectName("actionRes_Camera_1")
        self.actionRes_Camera_2 = QtWidgets.QAction(MainWindow)
        self.actionRes_Camera_2.setObjectName("actionRes_Camera_2")
        self.actionAdj_Camera_1 = QtWidgets.QAction(MainWindow)
        self.actionAdj_Camera_1.setObjectName("actionAdj_Camera_1")
        self.actionAdj_Camera_2 = QtWidgets.QAction(MainWindow)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuSet_Resolutions.setTitle(_translate("MainWindow", "Set Resolutions"))
        self.menuAdjustment.setToolTip(_translate("MainWindow", "Adjust Brightness, Contrast and Saturation"))
        ...
        self.actionRes_Camera_1.setText(_translate("MainWindow", "Res Camera 1"))
        self.actionRes_Camera_2.setText(_translate("MainWindow", "Res Camera 2"))
        self.actionAdj_Camera_1.setText(_translate("MainWindow", "Adj. Camera 1"))
        self.actionAdj_Camera_2.setText(_translate("MainWindow", "Adj. Camera 2"))
