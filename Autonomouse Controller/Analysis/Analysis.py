...
def binned_performance(mouse, bin_size, idx):
    """
...
def weighted_binned_performance(mouse, bin_size, idx):
    """
    ...
    binned_perf_m : list of float
        List of correct rejection ratein bin to be viewed in graphic view on
        analysis window.
    """
